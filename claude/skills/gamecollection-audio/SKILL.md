---
name: gamecollection-audio
description: HX Audio Player for music and sound playback. Use when implementing music playback, sound effects, HXMusic, HXSound, or audio in Game Collection. Uses hxaudio-v331.aar in core/audio.
---

# Game Collection Audio (HX Audio Player)

Use HX Audio Player for music and sound in Game Collection. The library is in `core/audio` (hxaudio-v331.aar). Supports Android 2.3+ with workarounds for MediaPlayer/SoundPool bugs.
